...
const data = {
  ...
  navMain: [
    ...
    { title: 'Brand Kits', url: '/brand-kits', icon: Tag, items: [] },
    { title: 'Templates', url: '/templates', icon: Layers, items: [] },
    { title: 'Calendar', url: '/calendar', icon: Calendar, items: [] },
    { title: 'Analytics', url: '/analytics', icon: PieChart, items: [] },
    { title: 'Approvals', url: '/approvals', icon: ClipboardCheck, items: [] },
    {
